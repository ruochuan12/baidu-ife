...
console.log(_san2.default, 'this is san');
console.log("hello world");
function out(str) {
    console.log(str);
}
out('parcel demo');
document.getElementById('app').innerHTML = 'parcel is cool!';
},{"san":12}],13:[function(require,module,exports) {
...
//# sourceMappingURL=/main.bb4aee97.map